...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppScreensAddAddComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function AddComponent(sliderService, expenseService) {
    ...
    AddComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function AddComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddComponent_Template_i_click_5_listener($event) {
  ...
  function srcAppScreensHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_expenses_expense_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/services/expenses/expense.service */
    "./src/app/services/expenses/expense.service.ts");
    /* harmony import */
    ...
    function HomeComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_div_1_Template_i_click_3_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5);

          var expense_r3 = ctx.$implicit;

          var ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r4.expenseService.deleteExpense(expense_r3.key);
        });
    ...
    /*#__PURE__*/
    function () {
      function HomeComponent(expenseService) {
    ...
    HomeComponent.ɵfac = function HomeComponent_Factory(t) {
      return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_expenses_expense_service__WEBPACK_IMPORTED_MODULE_1__["ExpenseService"]));
    };
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 3,
      consts: [[1, "home-component-container"], [4, "ngFor", "ngForOf"], [1, "material-icons-outlined", 3, "click"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          type: src_app_services_expenses_expense_service__WEBPACK_IMPORTED_MODULE_1__["ExpenseService"]
        }];
      }, null);
    })();
    /***/
    ...
    function () {
      ...
      _createClass(ExpenseService, [{
        ...
        value: function addExpense(expense) {
          ...
          var tx = this.db.transaction(['expenses'], 'readwrite');
          var store = tx.objectStore('expenses'); // Put the sticky note into the object store

          store.add(expense); // Wait for the database transaction to complete

          tx.oncomplete = function () {
            _this.refreshExpenses();
          };
        ...
        value: function getExpenses() {
          ...
          this.connection$.subscribe(function () {
            return _this2.refreshExpenses();
          });
          return this.expenses$.asObservable();
        }
      }, {
        key: "updateExpense",
        value: function updateExpense(key, value) {
          var _this3 = this;
        ...
        key: "deleteExpense",
        value: function deleteExpense(key) {
          var _this4 = this;
        ...
        value: function refreshExpenses() {
          ...
          var transaction = this.db.transaction(["expenses"]);
          var object_store = transaction.objectStore("expenses");
        ...
        value: function createExpenseDatabase() {
          ...
          var dbReq = indexedDB.open('ExpenseManagerDB', 1);

          dbReq.onupgradeneeded = function (event) {
            _this6.db = event.target.result;

            _this6.db.createObjectStore('expenses', {
              autoIncrement: true
            });
          };
