...
FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: FooterComponent, selectors: [["app-footer"]], decls: 7, vars: 0, consts: [[1, "footer-component-container"], [1, "flex-1", "flexbox", "justify"], ["routerLink", "/home", "routerLinkActive", "active", 1, "image-icon", "home"], [1, "image-icon", "add", 3, "click"], ["routerLink", "/settings", "routerLinkActive", "active", 1, "image-icon", "settings"]], template: function FooterComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FooterComponent_Template_div_click_4_listener($event) { return ctx.sliderService.activate(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
AddComponent.ɵfac = function AddComponent_Factory(t) { return new (t || AddComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_slider_slider_service__WEBPACK_IMPORTED_MODULE_2__["SliderService"])); };
AddComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AddComponent, selectors: [["app-add"]], decls: 56, vars: 4, consts: [[1, "add-component-container"], [1, "flexbox", "align", "h-100", "space-between", "p-0-8", "slider-header"], [1, "material-icons-outlined", "slider-header-icon", 3, "click"], [1, "material-icons-outlined", "slider-header-icon"], [1, "content-container"], ["appearance", "standard"], ["pattern", "[0-9]*", "type", "text", "matInput", "", "required", ""], ["matInput", "", 3, "matDatepicker", "formControl"], ["matSuffix", "", 3, "for"], ["picker1", ""], ["type", "date", "matInput", "", 3, "value"], ["type", "date", "name", "datevalue"], ["matNativeControl", "", "required", ""], ["value", "volvo"], ["value", "saab"], ["value", "mercedes"], ["value", "audi"], ["matInput", ""]], template: function AddComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AddComponent, [{
    ...
    }], function () { return [{ type: src_app_services_slider_slider_service__WEBPACK_IMPORTED_MODULE_2__["SliderService"] }]; }, null); })();
