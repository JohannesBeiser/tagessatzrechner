...
export const slideInAnimation =
  trigger('routeAnimations', [
    ...
    transition('Home => Income, Home => Groups,Home => Analysis, Groups => Income, Groups => Analysis, Income => Analysis', [
      ...
      transition('AboutSettings => Settings,TagSettings => Settings,RecurringSettings => Settings, GroupsSettings => Settings, DefaultsSettings => Settings, GeneralSettings => Settings, CategorySettings => Settings', [
        style({ position: 'relative' }),
        query(':enter, :leave', [
          style({
            position: 'absolute',
      ...
      transition('Settings => AboutSettings,Settings => RecurringSettings,Settings => TagSettings, Settings => GroupsSettings, Settings => DefaultsSettings, Settings => GeneralSettings, Settings => CategorySettings', [
        style({ position: 'relative' }),
        query(':enter, :leave', [
          style({
            position: 'absolute',
